...
.writeEVsLoop              ; set all EVs to 0
	...
	ld bc, $a
	rst CopyDataRST          ; copy stats of cur enemy mon
	pop hl
	jr .done
.calcFreshStats
	pop hl
...
;;;;;;;;;;
	...
	ld d, h
	ld hl, wLoadedMon
	rst CopyDataRST    ; write new mon's data (from wLoadedMon)
	ld hl, wPartyMonOT
	ld a, [wPartyCount]
	dec a
	call SkipFixedLengthTextEntries
	...
	call SkipFixedLengthTextEntries
	ld bc, NAME_LENGTH
	rst CopyDataRST    ; write new mon's OT name (from an enemy mon)
	ld hl, wPartyMonNicks
	ld a, [wPartyCount]
	dec a
	call SkipFixedLengthTextEntries
	...
	call SkipFixedLengthTextEntries
	ld bc, NAME_LENGTH
	rst CopyDataRST    ; write new mon's nickname (from an enemy mon)
	ld a, [wcf91]
	ld [wd11e], a
	predef IndexToPokedex
	ld a, [wd11e]
