...
DEF GOLBAT_RG_XPOS EQU 16
DEF MANKEY_RB_XPOS EQU 13
DEF MANKEY_RG_XPOS EQU 16
DEF ARCANINE_RB_XPOS EQU 13
DEF ARCANINE_RG_XPOS EQU 16
DEF EXEGGUTOR_RB_XPOS EQU 13
DEF EXEGGUTOR_RG_XPOS EQU 16
