...
INCLUDE "data/pokemon/base_stats/gargoyle.asm" ; (CAP)
...
INCLUDE "data/pokemon/base_stats/probosicle.asm" ; (CAP)
...
INCLUDE "data/pokemon/base_stats/mandrelec.asm" ; (CAP)
...
INCLUDE "data/pokemon/base_stats/phantom.asm" ; (CAP)
...
INCLUDE "data/pokemon/base_stats/corupcake.asm" ; (CAP)
