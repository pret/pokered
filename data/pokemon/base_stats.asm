...
INCLUDE "data/pokemon/base_stats/spirit_torched.asm"
INCLUDE "data/pokemon/base_stats/spirit_chunky.asm"
INCLUDE "data/pokemon/base_stats/spirit_painless.asm"
INCLUDE "data/pokemon/base_stats/spirit_irradiated.asm"
