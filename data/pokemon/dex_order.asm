PokedexOrder:
	...
	db DEX_DROWZEE
	db DEX_GOLEM
	db DEX_HITMONCHAN ; SPIRIT_IRRADIATED
	db DEX_MAGMAR
	db DEX_MAGMAR ; volcanic magmar
	db DEX_ELECTABUZZ
	db DEX_MAGNETON
	db DEX_KOFFING
	...
	db DEX_HORSEA
	db DEX_SEADRA
	db DEX_DRAGONAIR ; WINTER_DRAGONAIR
	db 0 ; MISSINGNO.
	db DEX_SANDSHREW
	db DEX_SANDSLASH
	db DEX_OMANYTE
	...
	db DEX_KAKUNA
	db DEX_BEEDRILL
	db DEX_WIGGLYTUFF ; SPIRIT_PAINLESS
	db DEX_DODRIO
	db DEX_PRIMEAPE
	db DEX_DUGTRIO
	db DEX_VENOMOTH
