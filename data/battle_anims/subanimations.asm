SubanimationPointers:
	...
	dw Subanim_0BarbJab
	dw Subanim_0SparklesFalling
	dw Subanim_0CircleSplitting
	dw Subanim_0SoundWaveShot
	dw Subanim_2BoneToss
...
Subanim_1ExplosionSmallEnemy:
	...
	db FRAMEBLOCK_5A, BASECOORD_0F, FRAMEBLOCKMODE_00
...
Subanim_0CirclesCentering: ;PureRGBnote: FIXED: bug when enemy uses this subanimation - the coordinates are way off, switching to SUBANIMTYPE_HVFLIP fixed it
...
Subanim_0Circle_1Square_Appears: ;PureRGBnote: CHANGED: remove unused animation for space
...
Subanim_0Circle_1Square_HalfToss: ;PureRGBnote: CHANGED: remove unused animation for space
	;subanim SUBANIMTYPE_COORDFLIP, 3
...
Subanim_0Water_1Fire_Barrier: ;PureRGBnote: CHANGED: was unused, now it's used in the volcano for the magmar/moltres "buff" magma veil
	subanim SUBANIMTYPE_COORDFLIP, 7
	db FRAMEBLOCK_59, BASECOORD_7C, FRAMEBLOCKMODE_03 ; 1
	db FRAMEBLOCK_59, BASECOORD_7B, FRAMEBLOCKMODE_03 ; 2
	db FRAMEBLOCK_59, BASECOORD_7A, FRAMEBLOCKMODE_03 ; 3
	db FRAMEBLOCK_59, BASECOORD_79, FRAMEBLOCKMODE_03 ; 4
	db FRAMEBLOCK_59, BASECOORD_78, FRAMEBLOCKMODE_03 ; 5
	db FRAMEBLOCK_59, BASECOORD_77, FRAMEBLOCKMODE_03 
	db FRAMEBLOCK_59, BASECOORD_76, FRAMEBLOCKMODE_00

Subanim_0Water_1Fire_Geyser: ;PureRGBnote: CHANGED: remove unused animation for space
...
Subanim_0SparklesFalling:
	subanim SUBANIMTYPE_HVFLIP, 8
	db FRAMEBLOCK_7B, BASECOORD_64, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7B, BASECOORD_80, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7C, BASECOORD_64, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7C, BASECOORD_80, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7B, BASECOORD_B1, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7B, BASECOORD_B2, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7C, BASECOORD_B1, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7C, BASECOORD_B2, FRAMEBLOCKMODE_00

Subanim_0CircleSplitting: ;PureRGBnote: ADDED: reverse of double edge, used in TELEPORT
	subanim SUBANIMTYPE_HVFLIP, 6
	db FRAMEBLOCK_47, BASECOORD_66, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_47, BASECOORD_66, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_47, BASECOORD_66, FRAMEBLOCKMODE_00
...
Subanim_0SoundWaveShot: ; PureRGBnote: ADDED: used in sonicboom
	subanim SUBANIMTYPE_HVFLIP, 4
	db FRAMEBLOCK_2F, BASECOORD_40, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_2F, BASECOORD_41, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_2F, BASECOORD_42, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_2F, BASECOORD_21, FRAMEBLOCKMODE_00

Subanim_2BoneToss:
	subanim SUBANIMTYPE_REVERSE, 4
	db FRAMEBLOCK_7D, BASECOORD_40, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7E, BASECOORD_41, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7D, BASECOORD_42, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7E, BASECOORD_21, FRAMEBLOCKMODE_00

Subanim_2BoneRecover:
	subanim SUBANIMTYPE_REVERSE, 5
	db FRAMEBLOCK_7D, BASECOORD_10, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7E, BASECOORD_0E, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7D, BASECOORD_92, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7E, BASECOORD_32, FRAMEBLOCKMODE_00
	db FRAMEBLOCK_7D, BASECOORD_31, FRAMEBLOCKMODE_00
	
Subanim_2AngerSymbol:
	subanim SUBANIMTYPE_NORMAL, 1
	db FRAMEBLOCK_7F, BASECOORD_60, FRAMEBLOCKMODE_00
	
Subanim_2AngerSymbol_Enemy:
	subanim SUBANIMTYPE_NORMAL, 1
	db FRAMEBLOCK_7F, BASECOORD_00, FRAMEBLOCKMODE_00
