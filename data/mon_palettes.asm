MonsterPalettes:
	...
	db PAL_MEWMON    ; CHINCHOU
	db PAL_MEWMON    ; LANTURN
	...
	db PAL_GREENMON  ; TREECKO
	db PAL_GREENMON  ; GROVYLE
	db PAL_GREENMON  ; SCEPTILE
	db PAL_REDMON    ; TORCHIC
	db PAL_REDMON    ; COMBUSKEN
	db PAL_REDMON    ; BLAZIKEN
	db PAL_BLUEMON   ; MUDKIP
	db PAL_CYANMON   ; MARSHTOMP
	db PAL_CYANMON   ; SWAMPERT
	db PAL_GREYMON   ; POOCHYENA
	db PAL_GREYMON   ; MIGHTYENA
	db PAL_BROWNMON  ; ZIGZAGOON
	db PAL_BROWNMON  ; LINOONE
	db PAL_REDMON    ; WURMPLE
	db PAL_GREYMON   ; SILCOON
	db PAL_YELLOWMON ; BEAUTIFLY
	db PAL_PINKMON   ; CASCOON
	db PAL_PURPLEMON ; DUSTOX
	db PAL_GREENMON  ; LOTAD
	db PAL_GREENMON  ; LOMBRE
	db PAL_GREENMON  ; LUDICOLO
	db PAL_BROWNMON  ; SEEDOT
	db PAL_BROWNMON  ; NUZLEAF
	db PAL_BROWNMON  ; SHIFTRY
