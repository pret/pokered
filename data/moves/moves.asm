...
; Characteristics of each move.
	...
	move DOUBLESLAP,   TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,       100, 10
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  18, NORMAL,       100, 15
	...
	move BIND,         TRAPPING_EFFECT,             15, BUG,           75, 20
	...
	move ROLLING_KICK, FLINCH_SIDE_EFFECT2,         75, FIGHTING,      85, 15
	...
	move PIN_MISSILE,  TWO_TO_FIVE_ATTACKS_EFFECT,  25, BUG,          100, 20
	...
	move SUBMISSION,   NO_ADDITIONAL_EFFECT,        90, FIGHTING,     100, 25
	...
	move SOLARBEAM,    NO_ADDITIONAL_EFFECT,       120, GRASS,         85, 10
	move POISONPOWDER, POISON_EFFECT,                0, POISON,        75, 35
	move STUN_SPORE,   PARALYZE_EFFECT,              0, GRASS,         75, 30
	move SLEEP_POWDER, SLEEP_EFFECT,                 0, GRASS,         75, 15
	move PETAL_DANCE,  NO_ADDITIONAL_EFFECT,        80, GRASS,        100, 20
	...
	move THUNDER_WAVE, PARALYZE_EFFECT,              0, ELECTRIC,      80, 20
	move THUNDER,      PARALYZE_SIDE_EFFECT1,      120, ELECTRIC,      70, 10
	move ROCK_THROW,   NO_ADDITIONAL_EFFECT,        60, ROCK,          90, 15
	...
	move RAGE,         ATTACK_UP1_EFFECT,           20, NORMAL,       100, 20
	...
	move EGG_BOMB,     NO_ADDITIONAL_EFFECT,       100, GRASS,         75, 10
	...
	move SKULL_BASH,   DEFENSE_UP1_EFFECT,          70, NORMAL,       100, 15
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  20, NORMAL,       100, 15
	move CONSTRICT,    TRAPPING_EFFECT,             15, GRASS,        100, 35
	...
	move SKY_ATTACK,   NO_ADDITIONAL_EFFECT,       110, FLYING,        85,  5
	move TRANSFORM,    TRANSFORM_EFFECT,             0, NORMAL,       100, 10
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      20, WATER,        100, 30
	move DIZZY_PUNCH,  CONFUSION_EFFECT,            70, NORMAL,       100, 10
	...
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT1,         90, ROCK,          90, 10
	move HYPER_FANG,   FLINCH_SIDE_EFFECT1,         80, NORMAL,        90, 15
	move SHARPEN,      ATTACK_UP1_EFFECT,            0, NORMAL,       100, 30
	move CONVERSION,   CONVERSION_EFFECT,            0, NORMAL,       100, 30
	move TRI_ATTACK,   BURN_SIDE_EFFECT1,           80, NORMAL,       100, 10
