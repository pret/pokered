...
; Characteristics of each move.
	...
	move DOUBLESLAP,   TWO_TO_FIVE_ATTACKS_EFFECT,  25, NORMAL,        85, 25
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  25, STEEL,         85, 15
	...
	move BIND,         TRAPPING_EFFECT,             15, ROCK,         100, 20
	...
	move WRAP,         TRAPPING_EFFECT,             15, NORMAL,       100, 35
	...
	move POISON_STING, POISON_SIDE_EFFECT3,         25, POISON,       100, 35
	...
	move SING,         SLEEP_EFFECT,                 0, FAIRY,        100, 15
	move SUPERSONIC,   CONFUSION_EFFECT,             0, NORMAL,       100, 15
	move SONICBOOM,    SPECIAL_DAMAGE_EFFECT,       40, FLYING,       100, 20
	...
	move SUBMISSION,   NO_ADDITIONAL_EFFECT,        80, FIGHTING,      95, 25
	...
	move STUN_SPORE,   PARALYZE_EFFECT,              0, GRASS,        100, 30
	move SLEEP_POWDER, SLEEP_EFFECT,                 0, GRASS,        100, 15
	...
	move FIRE_SPIN,    TRAPPING_EFFECT,             25, FIRE,         100, 15
	...
	move HYPNOSIS,     SLEEP_EFFECT,                 0, PSYCHIC_TYPE, 100, 20
	...
	move NIGHT_SHADE,  NO_ADDITIONAL_EFFECT,        75, GHOST,        100, 15
	...
	move SMOKESCREEN,  ACCURACY_DOWN2_EFFECT,        0, NORMAL,       100, 20
	...
	move LICK,         PARALYZE_SIDE_EFFECT3,       25, GHOST,        100, 30
	move SMOG,         SMOG_SIDE_EFFECT,            20, POISON,       100, 15
	...
	move CONSTRICT,    FLINCH_SIDE_EFFECT2,         35, GHOST,        100, 15
	...
	move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  25, DRAGON,        85, 20
	move LEECH_LIFE,   DRAIN_HP_EFFECT,             80, BUG,          100, 15
	move LOVELY_KISS,  SLEEP_EFFECT,                 0, FAIRY,        100, 10
	...
	move PSYWAVE,      CONFUSION_SIDE_EFFECT2,      25, PSYCHIC_TYPE, 100, 15
	...
	move BONEMERANG,   ATTACK_TWICE_EFFECT,         55, GROUND,       100, 10
	move REST,         HEAL_EFFECT,                  0, PSYCHIC_TYPE, 100, 10
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT2,         75, ROCK,         100, 10
	...
	move FAIRY_WIND,     SPEED_DOWN1_EFFECT,          20, FAIRY,        100, 30
	move DAZZLING_GLEAM, NO_ADDITIONAL_EFFECT,        80, FAIRY,        100, 10
	move FLEUR_CANNON,   HYPER_BEAM_EFFECT,          150, FAIRY,         90,  5
	move DRAIN_KISS,     DRAIN_HP_EFFECT,             40, FAIRY,        100, 15
	move DRAIN_PUNCH,    DRAIN_HP_EFFECT,             40, FIGHTING,     100, 15
	move POISON_NEEDLE,  TWINEEDLE_EFFECT,            35, POISON,       100, 20
	move POISON_JAB,     POISON_SIDE_EFFECT2,         80, POISON,       100, 10
	move POISON_SLASH,   POISON_SIDE_EFFECT2,         70, POISON,       100, 15
	move CRUNCH,         FLINCH_SIDE_EFFECT2,         60, DARK,         100, 15
	move DARK_PULSE,     NO_ADDITIONAL_EFFECT,        90, DARK,         100, 15
	move PHANTOM_FORCE,  NO_ADDITIONAL_EFFECT,        90, GHOST,        100, 10
	move DRAGON_BREATH,  PARALYZE_SIDE_EFFECT2,       80, DRAGON,       100,  5
	move DRACO_METEOR,   HYPER_BEAM_EFFECT,          150, DRAGON,        90,  5
	move ICICLE_SHARD,   TWO_TO_FIVE_ATTACKS_EFFECT,  35, ICE,           85, 20
	move HURRICANE,      CONFUSION_SIDE_EFFECT,      110, FLYING,        80,  5
	move IRON_HEAD,      FLINCH_SIDE_EFFECT2,         75, STEEL,        100, 10
	move IRON_TAIL,      DEFENSE_DOWN_SIDE_EFFECT,    90, STEEL,        100, 10
