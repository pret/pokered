...
; Characteristics of each move.
	...
	move SELFDESTRUCT, EXPLODE_RECOIL_EFFECT,      140, FIRE,         100,  5
	...
	move KINESIS,      FIREWALL_EFFECT,             20, FIRE,          90, 30 ; -> FIREWALL
	...
	move BONEMERANG,   BONEMERANG_EFFECT,           60, BONEMERANG_TYPE, 95, 10 ; hits twice, 30% chance to lower speed of opponent
	...
	move CONVERSION,   CONVERSION_EFFECT,            0, TRI,          100,  5
