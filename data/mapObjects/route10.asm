Route10Object:
	...
	db $6 ; objects
	object SPRITE_BLACK_HAIR_BOY_2, $a, $2c, STAY, LEFT, $1, POKEMANIAC, $1
	object SPRITE_HIKER, $3, $39, STAY, UP, $2, HIKER, $7
	object SPRITE_BLACK_HAIR_BOY_2, $e, $40, STAY, LEFT, $3, POKEMANIAC, $2
	object SPRITE_LASS, $7, $19, STAY, LEFT, $4, JR_TRAINER_F, $7
	object SPRITE_HIKER, $3, $3d, STAY, DOWN, $5, HIKER, $8
	object SPRITE_LASS, $7, $36, STAY, DOWN, $6, JR_TRAINER_F, $8
