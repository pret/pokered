MtMoon1Object:
	...
	object SPRITE_BUG_CATCHER, $c, $10, STAY, RIGHT, $2, YOUNGSTER, $3
	object SPRITE_LASS, $1e, $4, STAY, DOWN, $3, LASS, $5
	object SPRITE_BLACK_HAIR_BOY_2, $18, $1f, STAY, UP, $4, SUPER_NERD, $1
	object SPRITE_LASS, $10, $17, STAY, DOWN, $5, LASS, $6
	object SPRITE_BUG_CATCHER, $7, $16, STAY, DOWN, $6, BUG_CATCHER, $7
	object SPRITE_BUG_CATCHER, $1e, $1b, STAY, RIGHT, $7, BUG_CATCHER, $8
