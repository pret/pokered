...
ENDC
	...
	db $a ; objects
IF DEF(_OPTION_BEACH_HOUSE)
	object SPRITE_BLACK_HAIR_BOY_1, $9, $7, STAY, RIGHT, 1, SWIMMER, 2
	object SPRITE_BLACK_HAIR_BOY_1, $c, $9, STAY, LEFT, 2, SWIMMER, 3
ELSE
...
IF DEF(_OPTION_BEACH_HOUSE)
	object SPRITE_SWIMMER, $9, $d, STAY, DOWN, $6, SWIMMER, $7
ELSE
