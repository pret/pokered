Route16Object:
	...
	db $7 ; objects
	object SPRITE_BIKER, $11, $c, STAY, LEFT, $1, BIKER, $5
	object SPRITE_BIKER, $e, $d, STAY, RIGHT, $2, CUE_BALL, $1
	object SPRITE_BIKER, $b, $c, STAY, UP, $3, CUE_BALL, $2
	object SPRITE_BIKER, $9, $b, STAY, LEFT, $4, BIKER, $6
	object SPRITE_BIKER, $6, $a, STAY, RIGHT, $5, CUE_BALL, $3
	object SPRITE_BIKER, $3, $c, STAY, RIGHT, $6, BIKER, $7
