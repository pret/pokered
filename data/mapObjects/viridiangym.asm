ViridianGymObject:
	...
	object SPRITE_BLACK_HAIR_BOY_1, $c, $7, STAY, DOWN, $2, COOLTRAINER_M, $9
	object SPRITE_HIKER, $b, $b, STAY, UP, $3, BLACKBELT, $6
	object SPRITE_ROCKER, $a, $7, STAY, DOWN, $4, TAMER, $3
	object SPRITE_HIKER, $3, $7, STAY, LEFT, $5, BLACKBELT, $7
	object SPRITE_BLACK_HAIR_BOY_1, $d, $5, STAY, RIGHT, $6, COOLTRAINER_M, $a
	object SPRITE_HIKER, $a, $1, STAY, DOWN, $7, BLACKBELT, $8
	object SPRITE_ROCKER, $2, $10, STAY, RIGHT, $8, TAMER, $4
