LoreleiObject:
	...
	db $4 ; warps
	warp $4, $b, $2, INDIGO_PLATEAU_LOBBY
	warp $5, $b, $2, INDIGO_PLATEAU_LOBBY
	...
	; warp-to
	warp_to $4, $b, LORELEIS_ROOM_WIDTH ; INDIGO_PLATEAU_LOBBY
	warp_to $5, $b, LORELEIS_ROOM_WIDTH ; INDIGO_PLATEAU_LOBBY
