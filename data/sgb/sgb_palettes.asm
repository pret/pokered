...
IF DEF(_RED)
	RGB 31,29,31, 30,30,17, 17,23,10, 21,00,04 ; PAL_LOGO1 "Edición Roja"
ENDC
IF DEF(_BLUE)
	RGB 31,29,31, 30,30,17, 21,00,04, 14,19,29 ; PAL_LOGO1 "Edición Azul"
ENDC
	RGB 31,29,31, 30,30,17, 18,18,24, 07,07,16 ; PAL_LOGO2 "POKéMON"
