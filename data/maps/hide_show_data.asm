...
VermilionCityHS:
	db VERMILION_CITY, VERMILIONCITY_SQUIRTLE_TRAINER, SHOW
FuchsiaCityHS:
	db FUCHSIA_CITY, FUCHSIA_CITY_COOLTRAINER, SHOW
SaffronCityHS:
...
Route24HS:
	...
	db ROUTE_24, ROUTE24_COOLTRAINER_M4,  SHOW
Route25HS:
...
RockTunnelB1FHS:
	db ROCK_TUNNEL_B1F, ROCKTUNNEL_DOME_FOSSIL,  SHOW
	db ROCK_TUNNEL_B1F, ROCKTUNNEL_HELIX_FOSSIL, SHOW
SilphCo9FHS:
...
PokemonMansionB1FHS:
	...
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_MEW,          SHOW
SafariZoneEastHS:
