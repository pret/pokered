MapSongBanks::
	...
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; POWER_PLANT_ROOF
	...
	db MUSIC_CITIES2, BANK(Music_Cities2) ; CERULEAN_OLD_ROD_HOUSE
	db MUSIC_CITIES2, BANK(Music_Cities2) ; CERULEAN_ROCKET_HOUSE_1F
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; CERULEAN_ROCKET_HOUSE_B1F
	...
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; DIAMOND_MINE
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; CINNABAR_VOLCANO
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; CINNABAR_VOLCANO_WEST
	...
	db MUSIC_CITIES1, BANK(Music_Cities1) ; TYPE_GUYS_HOUSE
	...
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; ROUTE_22_GATE
	...
	db MUSIC_CITIES2, BANK(Music_Cities2)   ; FUCHSIA_TREE_DELETER_HOUSE
	db MUSIC_CITIES1, BANK(Music_Cities1) ; FOSSIL_GUYS_HOUSE
