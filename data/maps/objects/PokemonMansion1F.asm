PokemonMansion1F_Object:
	...
	object_event 2, 13, SPRITE_GUARD, STAY, RIGHT, 3, OPP_FIREFIGHTER, 5
	object_event 19, 9, SPRITE_GUARD, STAY, LEFT, 4, OPP_FIREFIGHTER, 6
	object_event 14,  3, SPRITE_POKE_BALL, STAY, NONE, 5, ITEM_MANSION_1F_NORTH
	object_event 18, 21, SPRITE_POKE_BALL, STAY, NONE, 6, ITEM_MANSION_1F_SOUTHEAST_NEAR_PLANTS
