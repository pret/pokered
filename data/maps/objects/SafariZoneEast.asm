SafariZoneEast_Object:
	...
	object_event 21, 10, SPRITE_POKE_BALL, STAY, NONE, 6, ITEM_SAFARI_ZONE_EAST_NEAR_REST_HOUSE
	object_event  3,  7, SPRITE_POKE_BALL, STAY, NONE, 7, ITEM_SAFARI_ZONE_EAST_ABOVE_GRASS_PATCH
	object_event 20, 13, SPRITE_POKE_BALL, STAY, NONE, 8, ITEM_SAFARI_ZONE_EAST_ROCK_RIDGE
	object_event 15, 12, SPRITE_POKE_BALL, STAY, NONE, 9, TM_SAFARI_ZONE_EAST_POND_GRASS
