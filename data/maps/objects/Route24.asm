Route24_Object:
	...
	object_event 10,  5, SPRITE_POKE_BALL, STAY, NONE, 8, TM_ROUTE_24_NORTH_OF_NUGGET_BRIDGE
	object_event 14, 12, SPRITE_POKE_BALL, STAY, NONE, 9, TM_ROUTE_24_RETURN_SHORTCUT_NEW
