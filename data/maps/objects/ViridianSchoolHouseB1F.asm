	object_const_def
	const_export SCHOOLB1F_GUY_NEAR_STAIRS
	const_export SCHOOLB1F_RIGHT_TEACHER
	const_export SCHOOLB1F_LITTLE_GIRL
	const_export SCHOOLB1F_NERD
    const_export SCHOOLB1F_LEFT_TEACHER
	const_export SCHOOLB1F_STUDENT_TEACHER
	const_export SCHOOLB1F_DAISY_TUTOR
	const_export SCHOOLB1F_TUTEE_LEFT
	const_export SCHOOLB1F_TUTEE_RIGHT
	const_export SCHOOLB1F_ROCKER
	const_export SCHOOLB1F_BRUNETTE_GIRL
	const_export SCHOOLB1F_GAMEBOY_KID
