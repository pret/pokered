	...
	const_export SILPHCO7F_ITEM1
	const_export SILPHCO7F_ITEM2
...
SilphCo7F_Object:
	...
	object_event  1,  9, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO7F_ITEM1, ITEM_SILPH_CO_7F_WEST
	object_event 24, 11, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO7F_ITEM2, TM_SILPH_CO_7F_EAST
