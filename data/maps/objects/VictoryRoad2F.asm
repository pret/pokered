VictoryRoad2F_Object:
	...
	object_event 27,  5, SPRITE_POKE_BALL, STAY, NONE, 7, TM_BLIZZARD
	object_event 18,  9, SPRITE_POKE_BALL, STAY, NONE, 8, FULL_HEAL
	object_event  9, 11, SPRITE_POKE_BALL, STAY, NONE, 9, TM_SOLARBEAM
	object_event 11,  0, SPRITE_POKE_BALL, STAY, NONE, 10, TM_FIRE_BLAST
