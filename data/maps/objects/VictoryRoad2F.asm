VictoryRoad2F_Object:
	...
	object_event 21, 13, SPRITE_ROCKER, STAY, LEFT, 2, OPP_JUGGLER, 2
	...
	object_event 26,  3, SPRITE_ROCKER, STAY, LEFT, 5, OPP_JUGGLER, 5
	object_event 11,  5, SPRITE_BIRD2, STAY, UP, 6, MOLTRES, 50
	object_event 27,  5, SPRITE_POKE_BALL, STAY, NONE, 7, TM_VICTORY_ROAD_2F_NORTHEAST
	object_event 18,  9, SPRITE_POKE_BALL, STAY, NONE, 8, ITEM_VICTORY_ROAD_2F_CENTER_NEAR_STAIRS
	object_event  9, 11, SPRITE_POKE_BALL, STAY, NONE, 9, TM_VICTORY_ROAD_2F_SOUTH_CENTER
	object_event 11,  0, SPRITE_POKE_BALL, STAY, NONE, 10, TM_VICTORY_ROAD_2F_ABOVE_MOLTRES_NEW
