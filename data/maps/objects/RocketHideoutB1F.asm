RocketHideoutB1F_Object:
	...
	object_event 11, 14, SPRITE_POKE_BALL, STAY, NONE, 6, ITEM_HIDEOUT_B1F_WEST_NEAR_TABLES
	object_event  9, 17, SPRITE_POKE_BALL, STAY, NONE, 7, ITEM_HIDEOUT_B1F_UP_FROM_B2F_ARROW_AREA
