Route12_Object:
	...
	object_event 14, 35, SPRITE_POKE_BALL, STAY, NONE, 11, TM_ROUTE_12_SURF_DOCK
	object_event  5, 89, SPRITE_POKE_BALL, STAY, NONE, 12, ITEM_ROUTE_12_CUT_ALCOVE
	object_event  6, 104, SPRITE_POKE_BALL, STAY, NONE, 13, ITEM_ROUTE_12_CUT_GRASS_PATCH_NEW
