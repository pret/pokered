...
MtMoon1F_Object:
	...
	object_event  2, 20, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_POTION1, ITEM_MT_MOON_1F_LEFT_UP_FROM_ENTRANCE
	object_event  2,  2, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_MOON_STONE, ITEM_MT_MOON_1F_NORTHWEST_CORNER
	object_event 35, 31, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_RARE_CANDY, ITEM_MT_MOON_1F_SOUTHEAST_CORNER
	object_event 36, 23, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_ESCAPE_ROPE, ITEM_MT_MOON_1F_EAST
	object_event 20, 33, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_POTION2, ITEM_MT_MOON_1F_RIGHT_FROM_ENTRANCE
	object_event  5, 32, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_TM_WATER_GUN, TM_MT_MOON_1F_LEFT_DOWN_FROM_ENTRANCE
