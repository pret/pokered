VictoryRoad3F_Object:
	...
	object_event 26,  5, SPRITE_POKE_BALL, STAY, NONE, 5, ITEM_VICTORY_ROAD_3F_NORTHEAST_ALCOVE
	object_event  7,  7, SPRITE_POKE_BALL, STAY, NONE, 6, TM_VICTORY_ROAD_3F_NORTHWEST
