...
VictoryRoad3F_Object:
	...
	object_event 26,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_VICTORYROAD3F_MAX_REVIVE, ITEM_VICTORY_ROAD_3F_NORTHEAST_ALCOVE
	object_event  7,  7, SPRITE_POKE_BALL, STAY, NONE, TEXT_VICTORYROAD3F_TM_EXPLOSION, TM_VICTORY_ROAD_3F_NORTHWEST
