	...
	const_export VIRIDIANFOREST_LASS
	const_export VIRIDIANFOREST_YOUNGSTER5
	const_export VIRIDIANFOREST_ITEM1
	const_export VIRIDIANFOREST_ITEM2
	const_export VIRIDIANFOREST_ITEM3
...
ViridianForest_Object:
	...
	object_event  2, 42, SPRITE_COOLTRAINER_F, STAY, NONE, TEXT_VIRIDIANFOREST_LASS, OPP_LASS, 19
	object_event 13, 17, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_VIRIDIANFOREST_YOUNGSTER5, OPP_BUG_CATCHER, 15
	object_event 25, 11, SPRITE_POKE_BALL, STAY, NONE, TEXT_VIRIDIANFOREST_ITEM1, ITEM_VIRIDIAN_FOREST_NORTHEAST
	object_event 12, 29, SPRITE_POKE_BALL, STAY, NONE, TEXT_VIRIDIANFOREST_ITEM2, ITEM_VIRIDIAN_FOREST_BEFORE_LAST_BEND
	object_event  1, 31, SPRITE_POKE_BALL, STAY, NONE, TEXT_VIRIDIANFOREST_ITEM3, ITEM_VIRIDIAN_FOREST_LEFT_FROM_ENTRANCE
	object_event 27, 40, SPRITE_YOUNGSTER, STAY, NONE, TEXT_VIRIDIANFOREST_YOUNGSTER6
