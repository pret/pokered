...
SilphCo10F_Object:
	...
	object_event  2, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO10F_TM_EARTHQUAKE, TM_SILPH_CO_10F_BOXES_LEFT
	object_event  4, 14, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO10F_RARE_CANDY, ITEM_SILPH_CO_10F_BOXES_BOTTOM
	object_event  5, 11, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO10F_CARBOS, ITEM_SILPH_CO_10F_BOXES_RIGHT
