...
SafariZoneWest_Object:
	...
	object_event  8, 20, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_MAX_POTION, ITEM_SAFARI_ZONE_WEST_SOUTHERN_GRASS
	object_event  9,  7, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_TM_DOUBLE_TEAM, TM_SAFARI_ZONE_WEST_NEAR_SECRET_HOUSE
	object_event 18, 18, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_MAX_REVIVE, ITEM_SAFARI_ZONE_WEST_SOUTHEAST
	object_event 19,  7, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_GOLD_TEETH, ITEM_SAFARI_ZONE_WEST_GOLD_TEETH
