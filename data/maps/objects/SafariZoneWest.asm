	object_const_def
	const_export SAFARIZONEWEST_RANGER1
	const_export SAFARIZONEWEST_RANGER2
	const_export SAFARIZONEWEST_BURGLAR
	const_export SAFARIZONEWEST_POKEMANIAC
	const_export SAFARIZONEWEST_ROCKER
	const_export SAFARIZONEWEST_JUGGLER
	const_export SAFARIZONEWEST_PSYCHIC
	const_export SAFARIZONEWEST_ITEM1
	const_export SAFARIZONEWEST_ITEM2
	const_export SAFARIZONEWEST_ITEM3
	const_export SAFARIZONEWEST_ITEM4
