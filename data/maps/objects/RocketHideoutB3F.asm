	...
	const_export ROCKETHIDEOUTB3F_ITEM1
	const_export ROCKETHIDEOUTB3F_ITEM2
...
RocketHideoutB3F_Object:
	...
	object_event 26, 17, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB3F_ITEM1, TM_HIDEOUT_B3F_SOUTH_FROM_STAIRS
	object_event 20, 14, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB3F_ITEM2, ITEM_HIDEOUT_B3F_ARROW_AREA_EAST
