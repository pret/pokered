	...
	const_export ROCKTUNNEL_DOME_FOSSIL
	const_export ROCKTUNNEL_HELIX_FOSSIL
...
RockTunnelB1F_Object:
	...
	object_event  3, 31, SPRITE_FOSSIL, STAY, NONE, TEXT_ROCKTUNNEL_DOME_FOSSIL
	object_event  3, 32, SPRITE_FOSSIL, STAY, NONE, TEXT_ROCKTUNNEL_HELIX_FOSSIL
