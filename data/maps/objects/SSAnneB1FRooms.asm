...
SSAnneB1FRooms_Object:
	...
	object_event 11, 12, SPRITE_FIGHTING, STAY, NONE, TEXT_SSANNEB1FROOMS_MACHOKE
	object_event 20,  2, SPRITE_POKE_BALL, STAY, NONE, TEXT_SSANNEB1FROOMS_ITEM1, ITEM_SS_ANNE_B1F_ROOMS
	object_event 10,  2, SPRITE_POKE_BALL, STAY, NONE, TEXT_SSANNEB1FROOMS_ITEM2, TM_SS_ANNE_B1F_ROOMS
	object_event 12, 11, SPRITE_POKE_BALL, STAY, NONE, TEXT_SSANNEB1FROOMS_ITEM3, ITEM_SS_ANNE_B1F_ROOMS_MACHOKE
