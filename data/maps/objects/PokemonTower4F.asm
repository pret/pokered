PokemonTower4F_Object:
	...
	object_event 12, 10, SPRITE_POKE_BALL, STAY, NONE, 4, ITEM_TOWER_4F_EAST
	object_event  9, 10, SPRITE_POKE_BALL, STAY, NONE, 5, ITEM_TOWER_4F_CENTER
	object_event 12, 16, SPRITE_POKE_BALL, STAY, NONE, 6, ITEM_TOWER_4F_SOUTH
