...
PokemonTower4F_Object:
	...
	object_event 12, 10, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONTOWER4F_ELIXER, ITEM_TOWER_4F_EAST
	object_event  9, 10, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONTOWER4F_AWAKENING, ITEM_TOWER_4F_CENTER
	object_event 12, 16, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONTOWER4F_HP_UP, ITEM_TOWER_4F_SOUTH
