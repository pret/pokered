...
MtMoonB2F_Object:
	...
	object_event 25, 21, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOONB2F_HP_UP, ITEM_MT_MOON_B2F_DOWN_FIRST_LADDER
	object_event 29,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOONB2F_TM_MEGA_PUNCH, TM_MT_MOON_B2F_DOWN_SECOND_LADDER
