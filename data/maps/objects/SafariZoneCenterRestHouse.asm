	object_const_def
	const_export SAFARIZONECENTERRESTHOUSE_SARA
	const_export SAFARIZONECENTERRESTHOUSE_SCIENTIST
	const_export SAFARIZONECENTERRESTHOUSE_ERIK
...
SafariZoneCenterRestHouse_Object:
	...
	def_object_events
	object_event  3,  2, SPRITE_GIRL, STAY, DOWN, TEXT_SAFARIZONECENTERRESTHOUSE_SARA
	object_event  1,  4, SPRITE_SCIENTIST, WALK, UP_DOWN, TEXT_SAFARIZONECENTERRESTHOUSE_SCIENTIST
	object_event  4,  2, SPRITE_FISHER, STAY, DOWN, TEXT_SAFARIZONECENTERRESTHOUSE_ERIK
