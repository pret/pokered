...
RocketHideoutB2F_Object:
	...
	object_event  1, 11, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB2F_MOON_STONE, ITEM_HIDEOUT_B2F_ARROW_AREA_WEST
	object_event 16,  8, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB2F_NUGGET, ITEM_HIDEOUT_B2F_ARROW_AREA_NORTHEAST
	object_event  6, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB2F_TM_HORN_DRILL, TM_HIDEOUT_B2F_ARROW_AREA_CENTER
	object_event  3, 21, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB2F_SUPER_POTION, ITEM_HIDEOUT_B2F_ARROW_AREA_SOUTHWEST
