SilphCo1F_Object:
	...
	object_event  10, 14, SPRITE_SAILOR, STAY, UP, 2, OPP_SOLDIER, 3 ; person
	object_event  12, 14, SPRITE_SAILOR, STAY, UP, 3, OPP_SOLDIER, 4 ; person
	object_event  11, 14, SPRITE_GUARD, STAY, UP, 4, OPP_FIREFIGHTER, 4 ; person
