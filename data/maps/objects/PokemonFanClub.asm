PokemonFanClub_Object:
	...
	;object_event  6,  3, SPRITE_BROCK, STAY, LEFT, 1 ; person
	;object_event  1,  3, SPRITE_MISTY, STAY, RIGHT, 2 ; person
	;object_event  6,  4, SPRITE_LT_SURGE, STAY, LEFT, 3 ; person
	;object_event  1,  4, SPRITE_ERIKA, STAY, RIGHT, 4 ; person
	;object_event  3,  1, SPRITE_SABRINA, STAY, DOWN, 5 ; person
	;object_event  5,  1, SPRITE_BLAINE, STAY, DOWN, 6 ; person
