VictoryRoad1F_Object:
	...
	object_event 11,  0, SPRITE_POKE_BALL, STAY, NONE, 3, TM_VICTORY_ROAD_1F_NORTHEAST_TOP
	object_event  9,  2, SPRITE_POKE_BALL, STAY, NONE, 4, ITEM_VICTORY_ROAD_1F_NORTHEAST_LEFT
