...
CeruleanCave1F_Object:
	...
	def_object_events
	object_event  7, 13, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCAVE1F_ITEM1, ITEM_CERULEAN_CAVE_1F_WATER_ALCOVE_WEST
	object_event 19,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCAVE1F_ITEM2, ITEM_CERULEAN_CAVE_1F_WATER_ALCOVE_NORTH
	object_event  5,  0, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCAVE1F_ITEM3, ITEM_CERULEAN_CAVE_1F_RIDGE_NORTHWEST
