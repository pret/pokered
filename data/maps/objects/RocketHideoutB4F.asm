...
RocketHideoutB4F_Object:
	...
	object_event 10, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB4F_HP_UP, ITEM_HIDEOUT_B4F_WEST_FROM_B3F_STAIRS
	object_event  9,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB4F_TM_RAZOR_WIND, TM_HIDEOUT_B4F_NORTH_FROM_B3F_STAIRS
	object_event 12, 20, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB4F_IRON, ITEM_HIDEOUT_B4F_WEST_FROM_ELEVATOR
