...
PokemonTower6F_Object:
	...
	object_event  6,  8, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONTOWER6F_RARE_CANDY, ITEM_TOWER_6F_PATH_BLOCKER
	object_event 14, 14, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONTOWER6F_X_ACCURACY, ITEM_TOWER_6F_SOUTHEAST
