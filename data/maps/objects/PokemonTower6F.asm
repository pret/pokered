	...
	const_export POKEMONTOWER6F_ITEM1
	const_export POKEMONTOWER6F_ITEM2
...
PokemonTower6F_Object:
	...
	object_event  6,  8, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONTOWER6F_ITEM1, ITEM_TOWER_6F_PATH_BLOCKER
	object_event 14, 14, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONTOWER6F_ITEM2, ITEM_TOWER_6F_SOUTHEAST
