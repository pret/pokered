Route18_Object:
	...
	def_bg_events
	bg_event 43,  7, 6 ; Route18Text4
	bg_event 33,  5, 7 ; Route18Text5
	...
	object_event 10, 4, SPRITE_BIKER, STAY, NONE, 4, OPP_TAMER, 9
	object_event 24, 6, SPRITE_BIKER, STAY, DOWN, 5, OPP_ROCKER, 6
