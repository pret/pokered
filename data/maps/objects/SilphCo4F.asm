SilphCo4F_Object:
	...
	object_event  3,  9, SPRITE_POKE_BALL, STAY, NONE, 5, ITEM_SILPH_CO_4F_WEST_BOXES_LEFT
	object_event  4,  7, SPRITE_POKE_BALL, STAY, NONE, 6, ITEM_SILPH_CO_4F_WEST_BOXES_CENTER
	object_event  5,  8, SPRITE_POKE_BALL, STAY, NONE, 7, ITEM_SILPH_CO_4F_WEST_BOXES_RIGHT
