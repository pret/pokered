...
SilphCo4F_Object:
	...
	def_object_events
	object_event  6,  2, SPRITE_SILPH_WORKER_M, STAY, NONE, TEXT_SILPHCO4F_SILPH_WORKER_M ; person
	...
	object_event  3,  9, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO4F_FULL_HEAL, ITEM_SILPH_CO_4F_WEST_BOXES_LEFT
	object_event  4,  7, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO4F_MAX_REVIVE, ITEM_SILPH_CO_4F_WEST_BOXES_CENTER
	object_event  5,  8, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO4F_ESCAPE_ROPE, ITEM_SILPH_CO_4F_WEST_BOXES_RIGHT
