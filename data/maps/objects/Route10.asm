	...
	const_export ROUTE10_SUPER_NERD3
	const_export ROUTE10_ITEM1
...
Route10_Object:
	...
	object_event 13,  4, SPRITE_SUPER_NERD, STAY, RIGHT, TEXT_ROUTE10_SUPER_NERD3, OPP_SUPER_NERD, 7
	object_event 14, 32, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE10_ITEM1, TM_ROUTE_10_NEAR_POWER_PLANT_NEW
