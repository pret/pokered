...
SilphCo3F_Object:
	...
	def_object_events
	object_event 24,  8, SPRITE_SILPH_WORKER_M, STAY, NONE, TEXT_SILPHCO3F_SILPH_WORKER_M ; person
	...
	object_event  8,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO3F_ITEM1, ITEM_SILPH_CO_3F_WEST
