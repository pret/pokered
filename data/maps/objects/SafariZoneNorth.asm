SafariZoneNorth_Object:
	...
	def_warp_events
	warp_event  2, 35, 0, SAFARI_ZONE_WEST
	warp_event  3, 35, 1, SAFARI_ZONE_WEST
	warp_event  8, 35, 2, SAFARI_ZONE_WEST
	warp_event  9, 35, 3, SAFARI_ZONE_WEST
	warp_event 20, 35, 4, SAFARI_ZONE_CENTER
	warp_event 21, 35, 5, SAFARI_ZONE_CENTER
	warp_event 39, 30, 0, SAFARI_ZONE_EAST
	warp_event 39, 31, 1, SAFARI_ZONE_EAST
	warp_event 35,  3, 0, SAFARI_ZONE_NORTH_REST_HOUSE
