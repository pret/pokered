SafariZoneNorth_Object:
	...
	object_event 32, 20, SPRITE_YOUNGSTER, STAY, NONE, 3, OPP_COOLTRAINER_M, 7
	...
	object_event 25,  1, SPRITE_POKE_BALL, STAY, NONE, 7, ITEM_SAFARI_ZONE_NORTH_NEAR_REST_HOUSE
	object_event 19,  7, SPRITE_POKE_BALL, STAY, NONE, 8, TM_SAFARI_ZONE_NORTH_NEAR_REST_HOUSE
