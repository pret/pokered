...
CeruleanCave2F_Object:
	...
	object_event 29,  9, SPRITE_POKE_BALL, STAY, NONE, CERULEANCAVE2F_PP_UP, ITEM_CERULEAN_CAVE_2F_EAST
	object_event  4, 15, SPRITE_POKE_BALL, STAY, NONE, CERULEANCAVE2F_ULTRA_BALL, ITEM_CERULEAN_CAVE_2F_SOUTHWEST
	object_event 13,  6, SPRITE_POKE_BALL, STAY, NONE, CERULEANCAVE2F_FULL_RESTORE, ITEM_CERULEAN_CAVE_2F_CENTER
