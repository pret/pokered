	...
	const_export POKEMONMANSION3F_CHANNELER
	const_export POKEMONMANSION3F_ITEM1
	const_export POKEMONMANSION3F_ITEM2
...
PokemonMansion3F_Object:
	...
	object_event 27, 11, SPRITE_CHANNELER, WALK, LEFT_RIGHT, TEXT_POKEMONMANSION3F_CHANNELER, OPP_CHANNELER, 2
	object_event  1, 16, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION3F_ITEM1, ITEM_MANSION_3F_SOUTHWEST_ALCOVE
	object_event 25,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION3F_ITEM2, ITEM_MANSION_3F_NORTHEAST
