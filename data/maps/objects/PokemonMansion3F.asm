...
PokemonMansion3F_Object:
	...
	object_event  1, 16, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION3F_MAX_POTION, ITEM_MANSION_3F_SOUTHWEST_ALCOVE
	object_event 25,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION3F_IRON, ITEM_MANSION_3F_NORTHEAST
