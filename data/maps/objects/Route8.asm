...
Route8_Object:
	...
	def_bg_events
	bg_event 11,  3, TEXT_ROUTE8_UNDERGROUND_SIGN
	...
	object_event  6, 13, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE8_ITEM1, ITEM_ROUTE_8_NEAR_SAFFRON_GATE_NEW
