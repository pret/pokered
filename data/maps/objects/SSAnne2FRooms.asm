...
SSAnne2FRooms_Object:
	...
	object_event 12,  1, SPRITE_POKE_BALL, STAY, NONE, TEXT_SSANNE2FROOMS_ITEM1, ITEM_SS_ANNE_2F_ROOMS1
	...
	object_event  0, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_SSANNE2FROOMS_ITEM2, ITEM_SS_ANNE_2F_ROOMS2
