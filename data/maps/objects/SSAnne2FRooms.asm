...
SSAnne2FRooms_Object:
	...
	object_event 12,  1, SPRITE_POKE_BALL, STAY, NONE, TEXT_SSANNE2FROOMS_MAX_ETHER, ITEM_SS_ANNE_2F_ROOMS1
	...
	object_event  0, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_SSANNE2FROOMS_RARE_CANDY, ITEM_SS_ANNE_2F_ROOMS2
