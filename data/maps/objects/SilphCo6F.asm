...
SilphCo6F_Object:
	...
	object_event  3, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO6F_HP_UP, ITEM_SILPH_CO_6F_SOUTHWEST_BOXES_TOP
	object_event  2, 15, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO6F_X_ACCURACY, ITEM_SILPH_CO_6F_SOUTHWEST_BOXES_BOTTOM
