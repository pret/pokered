SilphCo6F_Object:
	...
	object_event 21,  6, SPRITE_SILPH_WORKER_WOMAN, STAY, DOWN, 3 ; person
	object_event 11, 10, SPRITE_SILPH_WORKER_WOMAN, STAY, RIGHT, 4 ; person
	...
	object_event  3, 12, SPRITE_POKE_BALL, STAY, NONE, 9, ITEM_SILPH_CO_6F_SOUTHWEST_BOXES_TOP
	object_event  2, 15, SPRITE_POKE_BALL, STAY, NONE, 10, ITEM_SILPH_CO_6F_SOUTHWEST_BOXES_BOTTOM
