Route2_Object:
	...
	object_event 13, 54, SPRITE_POKE_BALL, STAY, NONE, 4, ITEM_ROUTE_2_SOUTH2
	object_event 13, 45, SPRITE_POKE_BALL, STAY, NONE, 5, ITEM_ROUTE_2_SOUTH1
	object_event 13, 3, SPRITE_POKE_BALL, STAY, NONE, 6, TM_ROUTE_2_ABOVE_DIGLETT_CAVE_NEW
