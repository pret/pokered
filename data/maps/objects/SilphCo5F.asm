...
SilphCo5F_Object:
	...
	object_event  2, 13, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO5F_TM_TAKE_DOWN, TM_SILPH_CO_5F_SOUTHWEST
	object_event  4,  6, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO5F_PROTEIN, ITEM_SILPH_CO_5F_NORTHWEST
	object_event 21, 16, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO5F_CARD_KEY, ITEM_SILPH_CO_5F_SOUTH
