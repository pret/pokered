	...
	const_export FUCHSIACITY_FOSSIL_FAN
...
FuchsiaCity_Object:
	...
	object_event 30, 12, SPRITE_MONSTER2, STAY, NONE, TEXT_FUCHSIACITY_SLOWPOKE 
	object_event  8, 17, SPRITE_SEEL, WALK, ANY_DIR, TEXT_FUCHSIACITY_LAPRAS 
	object_event  6,  5, SPRITE_FOSSIL, STAY, DOWN, TEXT_FUCHSIACITY_FOSSIL 
	object_event  5,  8, SPRITE_GAMBLER, STAY, UP, TEXT_FUCHSIACITY_FOSSIL_FAN
