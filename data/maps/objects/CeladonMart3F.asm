	...
	const_export CELADONMART3F_TM_KID
...
CeladonMart3F_Object:
	...
	bg_event 18,  2, TEXT_CELADONMART3F_PARTY_GAME
	bg_event 19,  2, TEXT_CELADONMART3F_PLATFORMER_GAME
	...
	object_event  5,  2, SPRITE_LITTLE_BOY, STAY, DOWN, TEXT_CELADONMART3F_TM_KID
