	object_const_def
	const_export CHAMP_ARENA_PROXY_PLAYER
	const_export CHAMP_ARENA_CHALLENGER
	const_export CHAMP_ARENA_ASSISTANT
	const_export CHAMP_ARENA_TM_KID
	const_export CHAMP_ARENA_CROWD1
	const_export CHAMP_ARENA_CROWD2
	const_export CHAMP_ARENA_VARIABLE_CROWD1
	const_export CHAMP_ARENA_VARIABLE_CROWD2
	const_export CHAMP_ARENA_CROWD3
	const_export CHAMP_ARENA_VARIABLE_CROWD3
	const_export CHAMP_ARENA_CROWD4
