...
ProfOakData:
	...
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 68, GYARADOS, 70, NIDOKING, 70, ESPEON, 0
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 68, GYARADOS, 70, NIDOKING, 70, GOROCHU, 0
