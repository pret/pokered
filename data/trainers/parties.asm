...
LtSurgeData:
	db $FF, 5, VOLTORB, 5, PIKACHU, 5, PIKACHU, 0
...
Green2Data:
; SS Anne 2F
	db $FF, 5, PIDGEY, 5, RATTATA, 5, ABRA, 5, SQUIRTLE, 0
	db $FF, 5, PIDGEY, 5, RATTATA, 5, ABRA, 5, BULBASAUR, 0
	db $FF, 5, PIDGEY, 5, RATTATA, 5, ABRA, 5, CHARMANDER, 0
; Pokémon Tower 2F
