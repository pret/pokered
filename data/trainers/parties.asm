...
GiovanniData:
; Rocket Hideout B4F
	db $FF, 25, RHYHORN, 24, KANGASKHAN, 29, PERSIAN, 0
; Silph Co. 11F
	db $FF, 37, RHYHORN, 35, KANGASKHAN, 37, NIDOQUEEN, 41, PERSIAN, 0
; Viridian Gym
...
BlaineData:
	db $FF, 42, GROWLITHE, 40, NINETALES, 42, RAPIDASH, 47, ARCANINE, 0

SabrinaData:
	db $FF, 38, KADABRA, 37, MR_MIME, 38, HYPNO, 43, ALAKAZAM, 0
