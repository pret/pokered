...
BrunoData:
	db $FF, 53, POLIWRATH, 55, HITMONCHAN, 55, HITMONLEE, 56, PRIMEAPE, 58, MACHAMP, 0
...
AgathaData:
	db $FF, 56, GENGAR, 56, PARASECT, 55, NINETALES, 58, MAROWAK, 60, GENGAR, 0

LanceData:
	db $FF, 58, GYARADOS, 56, DRAGONAIR, 56, CHARIZARD, 60, AERODACTYL, 62, DRAGONITE, 0
