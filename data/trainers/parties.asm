...
Green1Data:
	...
	db 5,DRATINI,0
; Route 22
	db $FF,9,PIDGEY,8,EEVEE,0
	db $FF,9,PIDGEY,8,RHYHORN,0
	db $FF,9,PIDGEY,8,DRATINI,0
; Cerulean City
	db $FF,18,PIDGEOTTO,15,ABRA,15,RATTATA,17,EEVEE,0
	db $FF,18,PIDGEOTTO,15,ABRA,15,RATTATA,17,RHYHORN,0
	db $FF,18,PIDGEOTTO,15,ABRA,15,RATTATA,17,DRATINI,0
ProfOakData:
; Unused
...
MistyData:
	db $FF,21,PSYDUCK,22,STARYU,25,STARMIE,0
LtSurgeData:
	db $FF,22,VOLTORB,24,RAICHU,26,JOLTEON,0
ErikaData:
	db $FF,29,VICTREEBEL,24,TANGELA,29,VILEPLUME,0
KogaData:
	db $FF,37,KOFFING,39,MUK,37,VENOMOTH,43,WEEZING,0
BlaineData:
	db $FF,42,GROWLITHE,42,RAPIDASH,42,CHARIZARD,47,ARCANINE,0
SabrinaData:
	db $FF,42,KADABRA,40,MR_MIME,43,VENOMOTH,45,ALAKAZAM,0
GentlemanData:
; SS Anne 1F Rooms
...
Green2Data:
; SS Anne 2F
	db $FF,19,PIDGEOTTO,16,RATICATE,18,KADABRA,20,EEVEE,0
	db $FF,19,PIDGEOTTO,16,RATICATE,18,KADABRA,20,RHYHORN,0
	db $FF,19,PIDGEOTTO,16,RATICATE,18,KADABRA,20,DRATINI,0
; Pokémon Tower 2F
	db $FF,25,PIDGEOTTO,23,GROWLITHE,22,EXEGGCUTE,20,KADABRA,25,EEVEE,0
	db $FF,25,PIDGEOTTO,23,GYARADOS,22,GROWLITHE,20,KADABRA,25,RHYHORN,0
	db $FF,25,PIDGEOTTO,23,EXEGGCUTE,22,GYARADOS,20,KADABRA,25,DRATINI,0
; Silph Co. 7F
	db $FF,37,PIDGEOT,38,GROWLITHE,35,EXEGGCUTE,35,ALAKAZAM,40,JOLTEON,0
	db $FF,37,PIDGEOT,38,GYARADOS,35,GROWLITHE,35,ALAKAZAM,40,RHYDON,0
	db $FF,37,PIDGEOT,38,EXEGGCUTE,35,GYARADOS,35,ALAKAZAM,40,DRAGONAIR,0
; Route 22
	db $FF,47,PIDGEOT,45,RHYHORN,45,GROWLITHE,47,EXEGGCUTE,50,ALAKAZAM,53,JOLTEON,0
	db $FF,47,PIDGEOT,45,RHYHORN,45,GYARADOS,47,GROWLITHE,50,ALAKAZAM,53,RHYDON,0
	db $FF,47,PIDGEOT,45,RHYHORN,45,EXEGGCUTE,47,GYARADOS,50,ALAKAZAM,53,DRAGONAIR,0
Green3Data:
	db $FF,61,PIDGEOT,59,ALAKAZAM,61,RHYDON,61,ARCANINE,63,EXEGGUTOR,65,JOLTEON,0
	db $FF,61,PIDGEOT,59,ALAKAZAM,61,RHYDON,61,GYARADOS,63,ARCANINE,65,RHYDON,0
	db $FF,61,PIDGEOT,59,ALAKAZAM,61,RHYDON,61,EXEGGUTOR,63,GYARADOS,65,DRAGONITE,0
LoreleiData:
