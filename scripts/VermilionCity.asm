...
VermilionCity_TextPointers:
	...
	dw_const VermilionCitySquirtleTrainerText,    TEXT_VERMILIONCITY_SQUIRTLE_TRAINER
...
VermilionCitySquirtleTrainerText:
	text_asm
	farcall VermilionCityPrintSquirtleTrainerText
	jp TextScriptEnd

VermilionCityPrintSquirtleTrainerText::
	CheckEvent EVENT_GOT_SQUIRTLE_FROM_SQUIRTLE_TRAINER
	jr nz, .asm_f1a69
	ld a, [wBeatGymFlags]
	bit 2, a ; THUNDERBADGE
	jr nz, .asm_f1a24
	ld hl, SquirtleTrainerText1
	call PrintText
	ret

.asm_f1a24
	ld hl, SquirtleTrainerText2
	call PrintText
	call YesNoChoice
	...
	ld a, $1
	ld [wDoNotWaitForButtonPressAfterDisplayingText], a
	ld hl, SquirtleTrainerText3
	call PrintText
	SetEvent EVENT_GOT_SQUIRTLE_FROM_SQUIRTLE_TRAINER
	ret

.asm_f1a62
	ld hl, SquirtleTrainerText4
	call PrintText
	ret

.asm_f1a69
	ld hl, SquirtleTrainerText5
	call PrintText
	ret

SquirtleTrainerText1:
	text_far _SquirtleTrainerText1
	text_end

SquirtleTrainerText2:
	text_far _SquirtleTrainerText2
	text_end

SquirtleTrainerText3:
	text_far _SquirtleTrainerText3
	text_waitbutton
	text_end

SquirtleTrainerText4:
	text_far _SquirtleTrainerText4
	text_end

SquirtleTrainerText5:
	text_far _SquirtleTrainerText5
	text_end