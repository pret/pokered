...
ViridianCityScriptPointers: ; 18ffd (6:4ffd)
	dw ViridianCheckCoords
	dw ViridianOldMan
	dw ViridianOldManEnd
	dw ViridianDelay

ViridianCheckCoords: ; 19005 (6:5005)
	call ViridianCheckIfNearGymDoor
	jp ViridianCheckNearOldMan

ViridianCheckIfNearGymDoor: ; 1900b (6:500b)
	ld a, [$d74c]
	bit 0, a
	ret nz
	ld a, [W_OBTAINEDBADGES]
	cp %01111111 ;Check if you have the first seven badges.
	jr nz, .ViridianDenyGymAccess ; 0x19016 $6
	ld hl, $d74c
	set 0, [hl]
	ret
.ViridianDenyGymAccess
	ld a, [W_YCOORD]
	cp $8
	ret nz
	ld a, [W_XCOORD]
	...
	call ViridianWalkDown
	ld a, $3
	ld [W_VIRIDIANCITYCURSCRIPT], a
	ret

ViridianCheckNearOldMan: ; 1903d (6:503d)
	ld a, [$d74b]
	bit 5, a
	ret nz
	ld a, [W_YCOORD]
...
ViridianOldManEnd: ; 1908f (6:508f)
	ld a, [$ff00+$eb]
	ld [$c134], a
	ld a, [$ff00+$ec]
	ld [$c136], a
