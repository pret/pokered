...
PewterCityScriptPointers: ; 19243 (6:5243)
	dw PewterCheckCoords
	dw PewterExplainMuseum
	dw PewterMuseumTourHideNPC
	dw PewterMuseumTourEnableMovement
	dw PewterEndGymWalk
	dw PewterGymTourHideNPC
	dw PewterGymTourEnableMovement

PewterCheckCoords: ; 19251 (6:5251)
	xor a
	ld [W_MUSEUMF1CURSCRIPT], a
	ld hl, $d754
	res 0, [hl]
	call PewterGymIntroducer
	ret

PewterGymIntroducer: ; 1925e (6:525e)
	ld a, [$d755]
	bit 7, a
	ret nz
...
PewterExplainMuseum: ; 19280 (6:5280)
	ld a, [$cc57]
	and a
	ret nz
	ld a, $3
...
PewterMuseumTourHideNPC: ; 192d3 (6:52d3)
	ld a, [$d730]
	bit 0, a
	ret nz
	ld a, $3
...
PewterMuseumTourEnableMovement: ; 192e9 (6:52e9)
	ld a, $3
	ld [$cf13], a
	call Func_32fe
	ld a, $3
...
PewterGymTourHideNPC: ; 19359 (6:5359)
	ld a, [$d730]
	bit 0, a
	ret nz
	ld a, $4
...
PewterGymTourEnableMovement: ; 1936f (6:536f)
	ld a, $5
	ld [$cf13], a
	call Func_32fe
	ld a, $4
