...
PalletTownScriptPointers: ; 18e73 (6:4e73)
	dw PalletCheckIfOakAppears
	dw PalletOakAppears
	dw PalletOakWalks
	dw PalletOaksWarning
	dw PalletDummyScript
	dw PalletTownScript5
	dw PalletDummyScript2

PalletCheckIfOakAppears: ; 18e81 (6:4e81)
	ld a,[$D747]
	bit 0,a
	ret nz
	ld a,[W_YCOORD]
...
PalletOaksWarning: ; 18f12 (6:4f12)
	ld a,[$D730]
	bit 0,a
	ret nz
	xor a
...
PalletDummyScript: ; 18f4b (6:4f4b)
	ld a,[$CC57]
	and a
	ret nz
...
.next
	...
	ld hl,$D74B
	set 6,[hl]
PalletDummyScript2: ; 18f87 (6:4f87)
	ret
