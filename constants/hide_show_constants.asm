...
; and are detected in wMissableObjectList)
	...
	const HS_SS_ANNE_2F_ROOMS_ITEM_2       ; 7B X
	const HS_SS_ANNE_B1F_ROOMS_ITEM_1      ; 7C X
	const HS_SS_ANNE_B1F_ROOMS_ITEM_2      ; 7D X
	const HS_SS_ANNE_B1F_ROOMS_ITEM_3      ; 7E X
	const HS_WUGTRIO                       ; 7F X 
	const HS_VICTORY_ROAD_3F_ITEM_1        ; 80 X
	const HS_VICTORY_ROAD_3F_ITEM_2        ; 81 X
	const HS_VICTORY_ROAD_3F_BOULDER       ; 82
	const HS_ROCKET_HIDEOUT_B1F_ITEM_1     ; 83 X
	const HS_ROCKET_HIDEOUT_B1F_ITEM_2     ; 84 X
	const HS_ROCKET_HIDEOUT_B2F_ITEM_1     ; 85 X
	const HS_ROCKET_HIDEOUT_B2F_ITEM_2     ; 86 X
	const HS_ROCKET_HIDEOUT_B2F_ITEM_3     ; 87 X
	const HS_ROCKET_HIDEOUT_B2F_ITEM_4     ; 88 X
	const HS_ROCKET_HIDEOUT_B3F_ITEM_1     ; 89 X
	const HS_ROCKET_HIDEOUT_B3F_ITEM_2     ; 8A X
	const HS_ROCKET_HIDEOUT_B4F_GIOVANNI   ; 8B
	const HS_ROCKET_HIDEOUT_B4F_JAMES      ; 8C
	const HS_ROCKET_HIDEOUT_B4F_JESSIE     ; 8D
	const HS_ROCKET_HIDEOUT_B4F_ITEM_1     ; 8E X
	const HS_ROCKET_HIDEOUT_B4F_ITEM_2     ; 8F X
	const HS_ROCKET_HIDEOUT_B4F_ITEM_3     ; 90 X
	const HS_ROCKET_HIDEOUT_B4F_ITEM_4     ; 91
	const HS_ROCKET_HIDEOUT_B4F_ITEM_5     ; 92
	const HS_GARNET_ARTICUNO_G             ; 93
