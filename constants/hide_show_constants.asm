...
DEF NUM_HS_OBJECTS EQU const_value
	...
	const HS_CHAMP_ARENA_CHALLENGER ; 2C X
	const HS_CHAMP_ARENA_PROXY_PLAYER ; 2D X
	const HS_CHAMP_ARENA_TM_KID ; 2E X
	const HS_CHAMP_ARENA_CROWD_1 ; 2F X
	const HS_CHAMP_ARENA_CROWD_2 ; 30 X
	const HS_CHAMP_ARENA_VARIABLE_CROWD_1 ; 31 X
	const HS_CHAMP_ARENA_VARIABLE_CROWD_2 ; 32 X
	const HS_CHAMP_ARENA_CROWD_3 ; 33 X
	const HS_CHAMP_ARENA_VARIABLE_CROWD_3 ; 34 X
	const HS_CHAMP_ARENA_CROWD_4 ; 35 X
	const HS_INDIGO_PLATEAU_LOBBY_CHAMP_ARENA_ASSISTANT ; 36 X
	const HS_PROSPECTORS_HOUSE_PROSPECTOR ; 37 X
	const HS_VOLCANO_BLAINE ; 38 X
	const HS_VOLCANO_ARCANINE ; 39 X
	const HS_VOLCANO_MOLTRES ; 3A X
	const HS_VOLCANO_RUBY_1 ; 3B X
	const HS_VOLCANO_RUBY_2 ; 3C X
	const HS_VOLCANO_RUBY_3 ; 3D X
	const HS_VOLCANO_ANIMATION_PROXY ; 3E X
	const HS_VOLCANO_ITEM1 ; 3F X
	...
	const HS_DIGLETTS_CAVE_DIGLETT3 ; 46 X
	const HS_DIGLETTS_CAVE_DIGLETT4 ; 47 X
	const HS_LAVENDER_TOWN_CUBONE ; 48 X
	const HS_FUCHSIA_ERIK ; 49
	const HS_SAFARI_ZONE_CENTER_REST_HOUSE_SARA ; 4A
	const HS_SAFARI_ZONE_CENTER_REST_HOUSE_ERIK ; 4B
