...
; and are detected in wMissableObjectList)
	...
	const HS_VIRIDIAN_SCHOOL_HOUSE_DETENTION ; NEW X
	const HS_VIRIDIAN_SCHOOL_HOUSE_DETENTION2 ; NEW X
	const HS_VIRIDIAN_SCHOOL_HOUSE_B1F_DETENTION ; NEW X
	const HS_VIRIDIAN_SCHOOL_HOUSE_B1F_DETENTION2 ; NEW X
	; current length -> 249 (F9)
	; 5 slots remain
