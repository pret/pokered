...
DEF NUM_HS_OBJECTS EQU const_value
	...
	const HS_VIRIDIAN_SCHOOL_HOUSE_DETENTION ; 29 X
	const HS_VIRIDIAN_SCHOOL_HOUSE_DETENTION2 ; 2A X
	const HS_VIRIDIAN_SCHOOL_HOUSE_B1F_DETENTION ; 2B X
	const HS_VIRIDIAN_SCHOOL_HOUSE_B1F_DETENTION2 ; 2C X
	const HS_REDS_HOUSE_1F_DAD ; 2D X
