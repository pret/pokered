...
; SubanimationPointers indexes (see data/battle_anims/subanimations.asm)
	...
	const SUBANIM_BOTH_HEART_MUSIC
	...
	const SUBANIM_BOTH_CIRCLES_SQUARES_CENTERING_ENEMY
	const SUBANIM_BOTH_CIRCLE_SQUARE_TOSS_BACK
	...
	const SUBANIM_0_SOUNDWAVE
	const SUBANIM_UNUSED_CIRCLE_SQUARE_HALFTOSS
	...
	const SUBANIM_UNUSED_CIRCLE_SQUARE_APPEARS
	const SUBANIM_0_STATUS_SLEEP
	const SUBANIM_0_STATUS_SLEEP_ENEMY
	const SUBANIM_UNUSED_BARRIER_WATER_FIRE
	const SUBANIM_UNUSED_GEYSER_WATER_FIRE
	...
	const SUBANIM_BOTH_CIRCLE_SQUARE_CLOSING
	const SUBANIM_1_LEAVES_TOSS
	const SUBANIM_0_HORN_JAB_TWO
	const SUBANIM_0_HORN_JAB_THREE
